...
// import SingleView from './SignleView';
...
//   // Function to handle selecting a media item
...
//   return (
//     <>
//       {/* Conditionally render SingleView if a media item is selected */}
//       {selectedItem && (
//         <SingleView item={selectedItem} setSelectedItem={(item: MediaItem | undefined) => setSelectedItem(item || null)} />
//       )}

//       {/* Render the media items table */}
//       <h2>My Media</h2>
//       <table>
//         <thead>
//           <tr>
...
//               key={item.media_id}
//               item={item}
//               onSelect={handleSelectMedia} // Pass select handler
//               selectedItem={selectedItem} // Pass selectedItem to MediaRow
//               setSelectedItem={(item: MediaItem | undefined) => setSelectedItem(item || null)} // Correct type
//             />
//           ))}
//         </tbody>
//       </table>
